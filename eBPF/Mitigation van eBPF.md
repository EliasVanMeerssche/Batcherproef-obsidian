...
Het is mogelijk dat de rootkit zichtzelf verstopt waardoor systemen die voor de detectie moeten zorgen gesaboteerd zijn. Door een betrouwbare momentopname (snapshot) van het RAM-geheugen te maken via een hypervisor omzeil je dit probleem. Tools zoals **Volatility framework** kunnen offline analyses maken van het RAM-geheugen. [^2]
...
[^3]: analyzing-ebpf-rootkits-through-the-mitre-attck-framework
